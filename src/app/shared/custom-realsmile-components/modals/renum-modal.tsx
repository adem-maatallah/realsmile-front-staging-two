...
export default function RenumModal({ caseId }: any) {
    ...
    const onSubmit = async () => {
        ...
        const url = `${apiUrl}/cases/renumere`;
        ...
        try {
            ...
            closeModal();
            router.push(`/cases/renumerer/${response.data.newCaseId}`); // Redirecting to the page with the new case ID
        } catch (error) {
            console.error(error);
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                <Title as="h4" className="font-semibold">Confirmer la rénumération</Title>
            ...
            <div className="mt-4">
                <Text className="text-sm pb-5">
                    ...
                    accepté ce la rénumeration, il vous sera impossible de revenir en arrière ou d'annuler votre décision.
                </Text>
            </div>
