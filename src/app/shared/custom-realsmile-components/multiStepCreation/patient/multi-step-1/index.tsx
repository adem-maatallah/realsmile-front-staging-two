...
import StepFour from "@/app/shared/custom-realsmile-components/multiStepCreation/case/multi-step-1/step-4";
...
import StepSeven from "@/app/shared/custom-realsmile-components/multiStepCreation/case/multi-step-1/step-7";



import Congratulations
  from "@/app/shared/custom-realsmile-components/multiStepCreation/case/multi-step-1/congratulations";
...
export const MAP_STEP_TO_COMPONENT = {
  ...
  [Step.StepTwo]: StepThree,
  [Step.StepThree]: StepFour,
  [Step.StepFour]: StepFive,
  [Step.StepFive]: StepSix,
  [Step.StepSix]: StepSeven,
