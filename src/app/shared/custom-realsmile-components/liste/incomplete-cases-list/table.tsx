...
import { getColumns } from '@/app/shared/custom-realsmile-components/liste/incomplete-cases-list/columns';
import { useAuth } from '@/context/AuthContext';

const FilterElement = dynamic(
  () =>
    import(
      '@/app/shared/custom-realsmile-components/liste/incomplete-cases-list/filter-element'
    ),
  { ssr: false }
);
...
export default function IncompleteCasesTable({
  data = [],
  isLoading = false,
}: {
  data: any[];
