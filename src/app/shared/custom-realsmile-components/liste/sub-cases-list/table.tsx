...
import {getColumns} from '@/app/shared/custom-realsmile-components/liste/sub-cases-list/columns';
...
const FilterElement = dynamic(
    () =>
        import(
            '@/app/shared/custom-realsmile-components/liste/sub-cases-list/filter-element'
            ),
    {ssr: false}
);
...
export default function SubCasesTable({
                                               data = [],
                                               isLoading = false,
                                           }: {
    data: any[];
