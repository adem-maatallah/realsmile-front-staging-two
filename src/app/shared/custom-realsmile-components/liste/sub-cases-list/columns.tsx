...

    {
      ...
      render: (_: string, row: any) => (
        <div className="flex items-center justify-end gap-3 pe-3">
          ...
          <Tooltip
            size="sm"
            content={"Suivre l'évolution du cas"}
            placement="top"
            color="invert"
          >
            <Link href={routes.advacement}>
              <ActionIcon
                as="span"
                size="sm"
                variant="outline"
                className="hover:!border-gray-900 hover:text-gray-700"
              >
                <PiArrowBendDoubleUpRight className="h-4 w-4" />
              </ActionIcon>
            </Link>
          </Tooltip>
        </div>
