...
import { getColumns } from '@/app/shared/custom-realsmile-components/liste/needs-approval-cases/columns';
import { useAuth } from '@/context/AuthContext';

const FilterElement = dynamic(
  () =>
    import(
      '@/app/shared/custom-realsmile-components/liste/needs-approval-cases/filter-element'
    ),
  { ssr: false }
);
...
export default function NeedsApprovalCasesTable({
  data = [],
  isLoading = false,
}: {
  data: any[];
