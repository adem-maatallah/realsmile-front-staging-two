...
import RefuseCasePopover from '../../RefuseCasePopover';
        ...
        <div className="flex items-center justify-end gap-3 pe-3">
          ...
          {(user.role === 'doctor' ||
            ...
            !row.is_refused && (
              <RefuseCasePopover
                caseId={row.id}
                title={`Refuser le cas`}
                description={`Êtes vous sûre de vouloir refuser le cas #${row.id}?`}
                onRefuse={(id, reason) =>
                  console.log('Refused case', id, reason)
