...
import { getColumns } from '@/app/shared/custom-realsmile-components/liste/complete-list/columns';
import { useAuth } from '@/context/AuthContext';

const FilterElement = dynamic(
  () =>
    import(
      '@/app/shared/custom-realsmile-components/liste/complete-list/filter-element'
    ),
  { ssr: false }
);
...
export default function CompleteCasesTable({
  data = [],
  isLoading = false,
}: {
  data: any[];
