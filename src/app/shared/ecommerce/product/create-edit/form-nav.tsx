...
export const formParts = {
  ...
  shipping: 'shipping', // Ensure this matches the target section
};
...
export const menuItems = [
  ...
  { label: 'Shipping and Availability', value: formParts.shipping }, // Ensure this is properly linked
];
        ...
        <div className="inline-grid grid-flow-col gap-5 md:gap-7 lg:gap-10">
          {menuItems.map((tab, idx) => (
            <Link
              ...
              hashSpy={true}
              smooth={true}
              offset={idx === 0 ? -250 : -150} // Adjust this value if necessary
              duration={500}
