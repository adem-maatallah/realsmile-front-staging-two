    ...
    <div className={cn(className)}>
      <ControlledTable
        ...
        expandable={{
          ...
          expandIconColumnIndex: 0, // Ensures the expand icon is in the first column
          expandRowByClick: true, // Optional: expand row on click
          columnWidth: 40, // Explicitly set width of the expand icon column
        }}
        paginatorOptions={{
          pageSize,
          setPageSize,
