...
import CompleteCasesTable from "@/app/shared/custom-realsmile-components/liste/complete-list/table";
...
const pageHeader = {
  title: 'Tous les Cas Terminés',
  breadcrumb: [

    {
      name: 'Tous les Cas Terminés',
    },
  ],
};
...
export default function EnhancedTablePage() {
  ...
  return (
    ...
    >
      <CompleteCasesTable data={casesData} isLoading={isLoading} />
    </TableLayout>
  );
}
