...
const classes = {
  table:
    '[&_.rc-table-content]:overflow-x-auto [&_.rc-table-row:hover]:bg-gray-50 [&_.rc-table-row-expand-icon-cell]:w-14',
  thead:
...
export default function Table({
  ...
  const renderEmptyText = () =>
    isLoading ? (
      ...
      emptyText || (
        <div className="flex h-60 items-center justify-center rounded-xl border border-dashed border-gray-300">
          <Empty text="pas de data" />
        </div>
      )
    );
